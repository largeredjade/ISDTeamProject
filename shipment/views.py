...
def shipment_detail_list(request):
    ...
    return render(request, 'html/shipment_detail_list.html', {'shipments': shipments, 'shipment_detail': shipment_detail})
...
def delete_shipment_detail(request, shipment_id, product_id):
    ...
    if request.method == 'POST':
        ...
        return redirect('shipment_detail_list')
    return render(request, 'html/shipment_detail_delete.html', {'shipment_detail': shipment_detail, 'shipment': shipment_detail.shipment,'detail': shipment_detail})
